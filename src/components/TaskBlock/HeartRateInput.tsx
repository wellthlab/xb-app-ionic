...
const HeartRateInput = function (props: IHeartRateInputProps) {
    return (
        <React.Fragment>
            <Typography level="body2">{Strings.find_your_pulse_by_firmly}</Typography>

            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
                <Box component="img" alt={Strings.heart_rate_measure} src="/assets/heartrate.png" sx={{ width: 160 }} />
            </Box>
