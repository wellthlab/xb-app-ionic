...
const WallSit = (props) => {
  ...
  return (
    <>
      ...
      <p>
        Put your back against the wall, with your feet a thigh's-length in front
        of you. Slide your back down the wall until you are in a sitting
        position, with your thighs parallel to the floor.
      </p>
      <p>Time how long you can hold that position.</p>
      <p>
        If you can't get your thighs parallel with the floor, that's no problem.
        Note how low you can get; and don't worry about timing yourself.
      </p>
