...
const PushPull = (props) => {
  ...
  return (
    <IonContent class="ion-padding">
      ...
      <p>
        Fundamental concepts to strength training – or resistance training, or
        body weight work, or calisthenics – are The Push and The Pull. These are
        two basic human movements that we do all the time, every day of our
        lives.
      </p>
      <p>
        ...
        <br></br>
        Here's a push. Swipe right for decreasing difficulty, or left for
      ...
      <p>
        ...
        <br></br>
        Here's a pull. Swipe right for decreasing difficulty, or left for
        increasing difficulty.
        <br></br>
      </p>
      <div>
      ...
      <p>
        Of course, as you have read on the wellthlab page, each of these moves
        can be categorised further, based on the part of your body which you are
        exercising.
      </p>
      <p>
        <strong>For eaxmple:</strong>
        <br></br>
        Here's a full body pull. Swipe right for a lower body pull, or left for
        an upper body pull.
        <br></br>
      </p>
      <IonSlides pager={true} options={slideOpts}>
      ...
      <p>
        Now, as a last categorisation, we split these moves into isolateral and
        bilateral exercises. Isolateral refers to using only one part of your
        body (i.e. leg, arm), whereas bilaterals train both sides of your body.
      </p>
      <p>
        <strong>For eaxmple:</strong>
        <br></br>
        Here's an isolateral full body push. Swipe right for a isolateral lower
        body push, or left for an isolateral upper body push.
        <br></br>
      </p>
      ...
      <IonSlides pager={true} options={slideOpts}>
        <IonSlide>
          ...
          >
            <p>
              {movepushLowerUni.difficulty ? movepushLowerUni.difficulty : ""}
            </p>
          </MovementInfoCard>
        </IonSlide>
        <IonSlide>
          ...
          >
            <p>
              {movepushFullUni.difficulty ? movepushFullUni.difficulty : ""}
            </p>
          </MovementInfoCard>
        </IonSlide>
        <IonSlide>
          ...
          >
            <p>
              {movepushUpperUni.difficulty ? movepushUpperUni.difficulty : ""}
            </p>
          </MovementInfoCard>
        </IonSlide>
      </IonSlides>
      ...
      <p>
        And that's all! Throughout this study, you will be selecting either a
        push, a pull, of one of those types: lower, upper, or full body
        exercises, isolateral or bilateral.
      </p>
      <p>
        <strong>
          When you are going to explore the movements in the app, or set them
          for your blocks:
        </strong>
        <br></br>
        You will be guided to choose the exercise for that particular week. You
        will enter a page on the app where you will be able to swipe: up/down to
        adjust the exercising area (upper, full, lower body), and swiping left
        or right for choosing the difficulty!
        <br></br>
      </p>
