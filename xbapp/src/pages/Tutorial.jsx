      ...
      <IonSlide>
        <IonContent>
          <IonCard>
            ...
            <IonCardContent>
              Welcome to Experiments in a Box - Here to tune in what can help
              you feel better.<br></br>
              The idea of an experiment in a box (XB for short) is to help you
              build helpful health practices by letting you test them out - to
              see what works for you.<br></br>
              <b>WHAT IS AN EXPERIMENT? </b>An experiment is a way to test an
              ...
              more refreshed in the morning. <br></br>
              You now have some new, tested information about how coffee may be
              affecting your sleep quality.
              <br></br>
              These are exactly the kinds of experiments an XB supports. The XB
              ...
              you the space to find out.
              <br></br>
              <b>EXPERIMENTS ARE SHORT AND SPECIFIC!</b> An XB only lasts a
              ...
              forever. It says: try it, check it out, and if it works, keep it!
              <br></br>
              <b>EXPERIMENTS ARE NOT LIFE!</b> Some experiments may seem a bit
              ...
              shaping your own eating practices. <br></br>
              ...
              time to explore something. <br></br>
              As one Experimenter said “I’ve heard that 8 hours of sleep a night
              is good for you, but if I hadn’t tried that as an experiment in a
              box, I would never have really found out. IT’s changed my life”
              <br></br>
              Not all experiment experiences may be that profound, but we hope
      ...
      <IonSlide>
        <IonContent>
          <IonCard>
            ...
            <IonCardContent>
              An Experiment in a Box has several features designed to make it as
              ...
              listed below:<br></br>
              <b>1. You Choose:</b> An experiment in a box may have many ways to
              ...
              <b>2. Guides to help you record your results:</b> A key part of a
              ...
              help you reflect on the effect of what you’re currently testing.
              <br></br>
              <b>3. Visualise your evidence:</b> Once you have gathered some
              ...
              morning rather than the afternoon. <br></br>
              <b>4. Working Together:</b> Sometimes it helps to work with others
              ...
              seem to feel better for more people. <br></br>
            </IonCardContent>
          </IonCard>
        </IonContent>
      </IonSlide>
        ...
        <IonContent>
          <IonCard>
            ...
            <IonCardContent>
              ...
              start up the XB app, they can choose to “Join a team.”
              <br></br>
              When they hit that button, they can enter the code you’ve given
              them, and they’ll be automatically added to the team/the
              experiment - and the team will show up on the list of experiments
              they are part of!<br></br>
            </IonCardContent>
            {account.loggedin ? (
              <IonButton routerLink="/about" expand="full">
