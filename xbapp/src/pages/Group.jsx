...
var Group = ({match, teams}) => {
        ...
        console.log("Find", gid, "in", teams.teams)
        ...
        // TODO: This needs to be refactored out into a component
        return (
            <IonPage>
                ...
                <IonContent>
                    ...
                    <IonModal isOpen={myModalMissingLastDay.isOpen}>
                        ...
                        <IonButton onClick={() => {setMyModalMissingLastDay({ isOpen: false });
                            history.push("/group/" + gid + "/" + chosenDay.day +"/timer"); window.location.reload()}}>Add Data</IonButton>
