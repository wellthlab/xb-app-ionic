    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen>
                <GenericAlert showAlert={showAlert} toggleAlert={toggleAlert} message={'If you have any questions, concerns, or want to feedback anything about the app, please contact us at gcm1u16@soton.ac.uk'} />
                <GenericModal showModal={showModal} toggleModal={toggleModal} title={"Privacy Notice"} message={privacy_notice} />

                <p><b>List of groups/chats for the teams you are part of:</b></p>
                {/** replace "Movement Minutes" with variable corresponding for each team the user is part of */}
                <p><a href="https://support.microsoft.com/en-us/office/use-a-link-or-code-to-join-a-team-c957af50-df15-46e3-b5c4-067547b64548" target="_blank">Movement Minutes: JOIN the MS Teams Group Chat</a></p>
                <p><b>What is XB?</b></p>
                ...
                <p><a href="javascript:void(0)" onClick={() => {toggleModal()}}>Privacy Notice</a></p>

                <p><a href="javascript:void(0)" onClick={() => {toggleAlert()}}>Contact</a></p>
...
<br></br>
If you have any questions about how your personal data is used, or wish to exercise any of your rights, please consult the University’s data protection webpage (<a href="https://www.southampton.ac.uk/legalservices/what-we-do/data-protection-and-foi.page" >here</a>) where you can make a request using our online form. If you need further assistance, please contact the University’s Data Protection Officer (data.protection@soton.ac.uk).<br></br>
<br></br>
<b>Thank you.</b><br></br>
Thank you for taking the time to read the information sheet and considering taking part in the research.<br></br>
</div>