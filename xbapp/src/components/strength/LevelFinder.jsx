  ...
  return (
    <div id="levelFinder">
      <p style={{ padding: "5px 8px 5px 8px" }}>
        It's important to find the right level for your strength moves. You're aiming to find a level where you
        can do TEN reps in a row. If you can do more than ten, it's too easy! And if you can't do the full ten, it's too hard.
      </p>

      <p style={{ padding: "5px 8px 5px 8px" }}>
        Most exercises have variations that make them easier or harder. Explore this move, using the hints below.
      </p>
