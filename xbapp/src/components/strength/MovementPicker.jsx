...
const moves = [
  ...
  **/
  ...
  },
  {
    ...
    images: [
      "supported_squat_rest.png",
      "supported_squat_engaged.png"
    ],
    difficulty:
  ...
  },
  {
    ...
    difficulty: "Use a higher object to increase difficulty (and don't underestimate the challenge of a higher object - this is just one leg working!). Use your unbent leg as little as possible for the movement.",
    warning:
  ...
  },
  {
    ...
    images: [
      "middle_split_rest.png",
      "middle_split_engaged.png"
    ],
    difficulty: "Remove footwear if creating too much friction with the floor during the movement. Progress to Cossack Squats if these are too easy.",
    warning: "Make sure there's nothing around you could fall on and injure yourself. Beware your feet being injured if you remove protective footwear.",
    alternative: [
      "cossacksquat"
    ],
    technique: "bilateral",
  },
  {
    ...
    images: [
      "cossack_squat_rest.png",
      "cossack_squat_engaged.png"
    ],
    difficulty: "Widen your stance slightly to increase difficulty. Go slowly and don't rely on momentum to complete the movement. Try the Bulgarian Split Squat if this is too easy.",
    warning:
  ...
  },
  {
    ...
    images: [
      "box_pistol_squat_rest.png",
      "box_pistol_squat_engaged.png"
    ],
    difficulty: "Use a higher object to increase difficulty. Try the Pistol Squat if this is too easy.",
    warning:
      "Check your object is sturdy enough not to move or lift under your weight. Make sure there's nothing around you that you could fall and injure yourself on.",
    alternative: [
      "pistolsquat"
  ...
  **/

  {
    ...
    images: [
      "wall_rdl_prep_rest.png",
      "wall_rdl_prep_engaged.png"
    ],
    difficulty: "Watch your form - keep your knees above your ankles at all times to work the correct muscles. Try the Glute Raise if you find lying down more practical.",
    warning:
      "Make sure there's nothing around you that you could fall and injure yourself on.",
    alternative: [
      "gluteraise"
  ...
  },
  {
    ...
    images: [
      "glute_raise_rest.png",
      "glute_raise_engaged.png"
    ],
  ...
  },
  {
    ...
    images: [
      "short_bridge_rest.png",
      "short_bridge_engaged.png"
    ],
    difficulty: "Very similar to a Glute Raise - the difference is you're curving your body to form a bridge shape rather than keeping a straight back. Try a Glute Raise if this is too difficult.",
    warning:
      "If in a public space, make sure you're clearly visible to others when lying on the ground.",
    alternative: [
      "gluteraise"
  ...
  },
  {
    ...
    images: [
      "single_leg_pike_rest.png",
      "single_leg_pike_engaged.png"
    ],
    difficulty: "Endeavor not to let the leg drop, but to control that lowering. Lift both legs at the same time to increase challenge (bilateral).",
    warning:
  ...
  */
  {
    ...
    images: [
      "the_swimmer_rest.png",
      "the_swimmer_engaged.png"
    ],
    difficulty:
      "This pairs very well with the Hollow Body Position.",
    warning:
  ...
  },
  {
    ...
    images: [
      "hollow_body_rest.png",
      "hollow_body_engaged.png"
    ],
  ...
  },
  {
    ...
    images: [
      "reverse_plank_rest.png",
      "reverse_plank_engaged.png"
    ],
    difficulty:
  ...
  },
  {
    ...
    images: [
      "angled_bridge_rest.png",
      "angled_bridge_engaged.png"
    ],
    difficulty:
  ...
  */
  {
    ...
    images: [
      "hindu_push_up_rest.png",
      "hindu_push_up_engaged.png"
    ],
    difficulty:
  ...
  },
  {
    ...
    images: [
      "elevated_push_up_rest.png",
      "elevated_push_up_engaged.png"
    ],
    difficulty:
  ...
  },
  {
    ...
    images: [
      "diamond_push_up_rest.png",
      "diamond_push_up_engaged.png"
    ],
    difficulty:
  ...
  */
  {
    ...
    images: [
      "pike_push_up_rest.png",
      "pike_push_up_engaged.png"],
    difficulty: "Bring your feet forward and your bottom upwards to increase load on your shoulders.",
    warning:
      "If in a public space, make sure you're clearly visible to others when lying on the ground.",
    alternative: [
      "diamondpushup",
  ...
  **/
  ...
  },
  {
    ...
    images: [
      "horizontal_pull_rest.png",
      "horizontal_pull_engaged.png"
    ],
    difficulty:
  ...
  },
  {
    ...
    images: [
      "assisted_pull_up_rest.png",
      "assisted_pull_up_engaged.png"
    ],
    difficulty:
  ...
  },
  {
    ...
    images: [
      "door_hang_pull_rest.png",
      "door_hang_pull_engaged.png"
    ],
    difficulty:
  ...
  },
  {
    ...
    images: [
      "one_arm_door_pull_rest.png",
      "one_arm_door_pull_engaged.png"
    ],
    difficulty:
      "Step towards the door frame to increase the angle and make this harder, or away to make it easier.",
    warning:
  ...
  **/
  ...
  },
  {
    ...
    images: [
      "pike_hold_engaged.png",
      "pike_hold_engaged.png"
    ],
    difficulty: "Once you've mastered these, progress to Cobra Push Ups or Hindu Push Ups.",
    warning:
      "If in a public space, make sure you're clearly visible to others when lying on the ground.",
    alternative: [
      "cobrapushup",
  ...
  },
  {
    ...
    difficulty: "Try The Swimmer instead if you prefer reps to holds. Pairs very well with Hollow Body Holds.",
    warning:
      "If in a public space, make sure you're clearly visible to others when lying on the ground.",
    alternative: [
      "swimmer",
  ...
  },
  {
    ...
    images: [
      "horse_stance_hold.png",
      "horse_stance_hold.png"
    ],
    difficulty: "If 15 seconds is too challenging, ease into the movement with easier squat movements such as Box Squats and Supported Squats.",
    warning:
      "Check for objects behind that could injure you in a fall.",
    alternative: [
      "boxsquat",
  ...
  },
  {
    ...
    images: [
      "shallow_push_up_hold.png",
      "shallow_push_up_hold.png"
    ],
    difficulty:
      "If these are too easy, progress to Flat Push Ups.",
    warning:
      "If in a public space, make sure you're clearly visible to others when laying on the ground.",
    alternative: [
      "flatpushup"
