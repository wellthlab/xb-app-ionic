    ...
    render(){
        ...
        return(
            ...
            {teams.map((group, i) => {
                ...
                var memberchip;
                if(members > 1) {
                    memberchip = <ion-chip color="success">
                        <ion-label><IonIcon icon={peopleOutline} /> {members}</ion-label>
                    </ion-chip>
                } else {
                    memberchip = <ion-chip color="success">
                        <ion-label><IonIcon icon={peopleOutline} /> Private Experiment</ion-label>
                    </ion-chip>
                }
                ...
                if(group.experiment.info === false) {
                    ...
                    return <ion-card key={i}><Link to={"/group/" + group._id}>
                        <ion-card-header>
                            ...
                            <ion-card-subtitle>{group.experiment.info.title}</ion-card-subtitle>
                        </ion-card-header>

                        <ion-card-content>
                            <ion-chip color="primary">
                                <ion-label><IonIcon icon={todayOutline} /> {daydesc}</ion-label>
                            </ion-chip>
