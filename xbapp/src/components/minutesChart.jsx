    ...
    return <div>
        ...
        {props.individual ?
            ...
            <div>
                ...
                <div style={{ flex: '0 0 auto', padding: '10px', textAlign: 'center' }}>Your Minutes vs. Team's Minutes</div>
                <div style={{ width: '400px', height: '300px', marginTop: '20px', marginLeft: 'auto', marginRight: 'auto', marginBottom: '1px' }}>
                    <Bar data={minutesData} options={optionsMinutes} />
                    
                </div>
                <div style={{ flex: '0 0 auto', padding: '10px', textAlign: 'center' }}>Your Mood vs. Team's Mood</div>
                <div style={{ width: '400px', height: '300px', marginTop: '20px', marginLeft: 'auto', marginRight: 'auto', marginBottom: '1px' }}>
